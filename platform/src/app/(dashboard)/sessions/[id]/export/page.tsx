  ...
  return (
    <div className="animate-fadeUp" style={{ maxWidth: 500 }}>
      ...
      <p style={{ fontSize: 13, color: 'var(--muted)', marginBottom: 32 }}>
        Scarica il file completo — stesso formato di fine elaborazione
      </p>

      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        {([
          { type: 'csv' as const,   label: 'CSV',   desc: 'Separatore ; — stesso file scaricabile a fine elaborazione' },
          { type: 'excel' as const, label: 'Excel', desc: 'File .xlsx — stesso file scaricabile a fine elaborazione' },
        ]).map(exp => (
